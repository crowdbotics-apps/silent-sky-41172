"""
Django settings for silent_sky_41172 project.
...
ROOT_URLCONF = 'silent_sky_41172.urls'
...
WSGI_APPLICATION = 'silent_sky_41172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_sky_41172 API",
    "DESCRIPTION": "API documentation for silent_sky_41172 App",
    "VERSION": "v1",
}
